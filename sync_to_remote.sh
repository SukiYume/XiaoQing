...
echo "Source: ./"
echo "Destination: production-host:/c/Users/testuser/Desktop/XiaoQing/XiaoQing_V3/"
echo ""
...
rsync -avzP ./ production-host:/c/Users/testuser/Desktop/XiaoQing/XiaoQing_V3/ \
    --exclude='bot.log' \
    --exclude='.git' \
    --exclude='data' \
    --exclude='logs' \
