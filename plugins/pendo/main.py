...
HELP_MAP = {
    ...
    "todo": [
        "✅ **待办事项 (Todo)**",
        "  - 别名: `task`, `t`, `待办`, `任务`",
        "• /pendo todo add - 交互式添加待办；后续字段输入 0 使用默认值",
        "• /pendo todo add <内容> [plan:YYYY-MM-DD] [deadline:YYYY-MM-DDTHH:MM] [remind:YYYY-MM-DDTHH:MM[,YYYY-MM-DDTHH:MM]] [cat:分类] [p:1-5] [#标签] - 快捷添加待办",
